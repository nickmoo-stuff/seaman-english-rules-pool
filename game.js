...
function newFrame(breaker=1){rackBalls();resetPotStreak();state=newState(breaker);moving=false;shot=null;placementMode='baulk';draggingCue=false;pendingChoice=null;choice.hidden=true;shootBtn.disabled=false;msg.textContent='Opening break — position the white anywhere in baulk, then break.';updateHUD();setTimeout(announceTurn,40);}
